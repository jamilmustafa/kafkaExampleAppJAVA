...
public class ConsumerGroupApp {
    ...
    private static void printRecords(ConsumerRecords<String, String> records) throws JsonMappingException, JsonProcessingException
    {
        ...
        for (ConsumerRecord<String, String> record : records) {
        	...
        	System.out.println(String.format("Topic: %s, Message for: %s, Message: %s",
        			record.topic(),
        			user.getNome(),
        			user.getMessage()));
        	}
            //System.out.println(String.format("Topic: %s, Partition: %d, Offset: %d, Key: %s", record.topic(), record.partition(), record.offset(), record.key()));
        }
    }
}
